...
public class B5_ArrayList {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Float> arrLstFloat = new ArrayList<Float>();
        ArrayList<Double> arrLstDouble = new ArrayList<Double>();
        ArrayList<Character> arrLstKyTu = new ArrayList<Character>();
        ...
        arrLstString.add(2, "POLY");
        
        //3. Lấy giá trị - get
        System.out.println(arrLstKhongDinhKieu.get(1));
        System.out.println(arrLstString.get(2));
        ...
        System.out.println(arrLstKhongDinhKieu.isEmpty());
