...
public class B9_Switch_Case {
    ...
    public static void main(String[] args) {
        ...
        input = sc.nextLine();
        switch (input) {//(input) biểu thức truyền vào
            case "a"://Giá trị của case phải tương ứng kiểu dữ liệu của biểu thức
                System.out.println("Anh chị chờ trong 30p");
                break;
            case "b":  
                System.out.println("Anh chị chờ trong 15p");
                break;                
            default:
